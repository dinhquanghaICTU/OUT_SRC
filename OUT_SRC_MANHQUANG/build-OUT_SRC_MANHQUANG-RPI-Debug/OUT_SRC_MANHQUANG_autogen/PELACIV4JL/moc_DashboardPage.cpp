...
#include "../../../OUT_SRC_MANHQUANG/ui/pages/DashboardPage.h"
...
static constexpr auto qt_meta_stringdata_CLASSDashboardPageENDCLASS = QtMocHelpers::stringData(
    "DashboardPage",
    "doorCommandRequested",
    "",
    "action",
    "simMotionRequested",
    "simObstacleRequested",
    "blocked"
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDashboardPageENDCLASS_t qt_meta_stringdata_CLASSDashboardPageENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 20),  // "doorCommandRequested"
        QT_MOC_LITERAL(35, 0),  // ""
        QT_MOC_LITERAL(36, 6),  // "action"
        QT_MOC_LITERAL(43, 18),  // "simMotionRequested"
        QT_MOC_LITERAL(62, 20),  // "simObstacleRequested"
        QT_MOC_LITERAL(83, 7)   // "blocked"
    },
    "DashboardPage",
    "doorCommandRequested",
    "",
...
Q_CONSTINIT const QMetaObject DashboardPage::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDashboardPageENDCLASS_t,
        ...
        // method 'doorCommandRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'simMotionRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'simObstacleRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void DashboardPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->doorCommandRequested((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->simMotionRequested(); break;
        case 2: _t->simObstacleRequested((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DashboardPage::doorCommandRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &DashboardPage::simMotionRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &DashboardPage::simObstacleRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void DashboardPage::doorCommandRequested(const QString & _t1)
{
...
// SIGNAL 1
void DashboardPage::simMotionRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void DashboardPage::simObstacleRequested(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
