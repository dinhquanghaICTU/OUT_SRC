...
bool MqttDiscoveryService::publishDoorCommand(const QString &deviceId, const QString &commandId,
...
void MqttDiscoveryService::sendConnect()
{
    ...
    const QByteArray clientId = QByteArrayLiteral("manhquang-server-")
