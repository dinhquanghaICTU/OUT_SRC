...
public:
    ...
    void setupUi(QWidget *LoginPage)
    {
        ...
        splitLoginCard->setMinimumSize(QSize(740, 420));
        splitLoginCard->setMaximumSize(QSize(780, 450));
        ...
        artLayout->setContentsMargins(24, 20, 24, 20);
        ...
        loginFormLayout->setContentsMargins(36, 24, 36, 20);
        ...
        formTopGap = new QSpacerItem(20, 6, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        demoButton->setMinimumSize(QSize(0, 36));
        ...
        bottomStretch = new QSpacerItem(20, 10, QSizePolicy::Minimum, QSizePolicy::Expanding);
