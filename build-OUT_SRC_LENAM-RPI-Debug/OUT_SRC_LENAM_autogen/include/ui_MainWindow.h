...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sideBar->setMinimumSize(QSize(0, 76));
        sideBar->setMaximumSize(QSize(16777215, 76));
        sideBarLayout = new QHBoxLayout(sideBar);
        sideBarLayout->setSpacing(12);
        sideBarLayout->setObjectName("sideBarLayout");
        sideBarLayout->setContentsMargins(18, 10, 18, 10);
        sideLogo = new QLabel(sideBar);
        sideLogo->setObjectName("sideLogo");
        sideLogo->setMinimumSize(QSize(52, 52));
        sideLogo->setMaximumSize(QSize(52, 52));
        ...
        navSpacer = new QSpacerItem(80, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "LeNam Control Center", nullptr));
