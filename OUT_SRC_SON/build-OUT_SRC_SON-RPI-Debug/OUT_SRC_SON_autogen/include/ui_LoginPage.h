...
public:
    ...
    void setupUi(QWidget *LoginPage)
    {
        ...
        loginCard->setMaximumSize(QSize(320, 16777215));
        loginFormLayout = new QVBoxLayout(loginCard);
        loginFormLayout->setSpacing(6);
        loginFormLayout->setObjectName("loginFormLayout");
        loginFormLayout->setContentsMargins(20, 14, 20, 14);
        logoLabel = new QLabel(loginCard);
        logoLabel->setObjectName("logoLabel");
        logoLabel->setMinimumSize(QSize(56, 56));
        logoLabel->setMaximumSize(QSize(56, 56));
