...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/quanghaictu/OUT_SRC/OUT_SRC_SON/build-OUT_SRC_SON-RPI-Debug/OUT_SRC_SON")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/OUT_SRC_SON" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/OUT_SRC_SON")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/OUT_SRC_SON"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/opt/cross-pi-gcc/bin/aarch64-linux-gnu-strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/OUT_SRC_SON")
    endif()
  endif()
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/quanghaictu/OUT_SRC/OUT_SRC_SON/build-OUT_SRC_SON-RPI-Debug/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/quanghaictu/OUT_SRC/OUT_SRC_SON/build-OUT_SRC_SON-RPI-Debug/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
