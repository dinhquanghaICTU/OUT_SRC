    ...
    : QWidget(parent), ui(new Ui::LoginPage)
{
    ...
    connect(ui->quickFillOpBtn, &QPushButton::clicked, this, [this] {
        ui->usernameEdit->setText(QStringLiteral("operator"));
        ui->passwordEdit->setText(QStringLiteral("operator123"));
        ui->loginButton->click();
    });
