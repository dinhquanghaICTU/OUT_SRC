...
public:
    ...
    bool insertReading(double soilMoisturePct, double temperatureC, double humidityPct,
    ...
    bool addAlert(const QString &source, const QString &severity, const QString &title,
