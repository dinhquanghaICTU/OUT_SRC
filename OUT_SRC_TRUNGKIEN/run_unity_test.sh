...
if [ -d "$SCRIPT_DIR/unity_test" ]; then
    ...
    echo -e "\033[1;31mError: Cannot find unity_test directory for OUT_SRC_TRUNGKIEN!\033[0m"
    exit 1
fi

echo -e "\033[1;34m============================================================\033[0m"
echo -e "\033[1;34m  BUILDING & RUNNING UNITY TEST: Trung Kien (HX710B Knock + UV Sensor)\033[0m"
...
gcc -Wall -Wextra -O2 -I. -o run_test_bin unity.c mock_hal.c test_trungkien_firmware.c -lm
