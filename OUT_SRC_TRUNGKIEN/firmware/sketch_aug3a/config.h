...
#define MQTT_PUB_CONFIG_REPORTED_TOPIC MQTT_TOPIC_PREFIX "/config/reported"
#define MQTT_SUB_COMMANDS_TOPIC MQTT_TOPIC_PREFIX "/commands"
#define MQTT_PUB_STATE_TOPIC MQTT_TOPIC_PREFIX "/state"
