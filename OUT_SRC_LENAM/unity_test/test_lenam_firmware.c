...
// Mock Firmware Logic for LENAM (BMP180 + IR Sensor + Buzzer Ring + Button + LED + MQTT)
...
void test_lenam_bmp180_simulation_math(void) {
    float temp1, press1;
...
void test_lenam_bmp180_bounds_validation(void) {
...
void test_lenam_ir_voting_filter(void) {
...
void test_lenam_button_debounce_and_events(void) {
    button_ctx_t btn;
    button_init(&btn);
...
void test_lenam_ring_controller(void) {
    ring_set(true);
...
void test_lenam_mqtt_telemetry_keys_and_schema(void) {
    char payload[512];
...
void test_lenam_mqtt_command_parsing(void) {
    char cmd_id[64];
...
void test_lenam_threshold_and_alert_logic(void) {
    // Normal conditions
...
int main(void) {
    UNITY_BEGIN();
    RUN_TEST(test_lenam_bmp180_simulation_math);
    RUN_TEST(test_lenam_bmp180_bounds_validation);
    RUN_TEST(test_lenam_ir_voting_filter);
    RUN_TEST(test_lenam_button_debounce_and_events);
    RUN_TEST(test_lenam_ring_controller);
    RUN_TEST(test_lenam_mqtt_telemetry_keys_and_schema);
    RUN_TEST(test_lenam_mqtt_command_parsing);
    RUN_TEST(test_lenam_threshold_and_alert_logic);
    return UNITY_END();
}
