...
bool mqtt_manager_publish_sensor(float temperature_c, float pressure_hpa, bool ir_detected)
{
    char payload[384];
    int length;
...
// void test_mqtt()
// {
//     if (mqtt_client == NULL || !mqtt_started || !mqtt_connected)
//         return;
//     esp_mqtt_client_publish(mqtt_client, MQTT_TELEMETRY_TOPIC, "Hello from ESP32", 0, 1, 0);
// }
